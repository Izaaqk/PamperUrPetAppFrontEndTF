  ...
  aceptar() {
    ...
    if (rol === 'propietario') {
      ...
      if (this.form.valid) {
        ...
        this.http.post<any>(`http://3.22.172.205:8080/api/propietario/${this.form.value['idAdminSeleccionado']}/${this.form.value['idMembresiaSeleccionado']}`, propietarioData)
          .subscribe((data) => {
      ...
      if (this.form.valid) {
        ...
        this.http.post<any>(`http://3.22.172.205:8080/api/paseador/${this.form.value['idAdminSeleccionado']}`, paseadorData)
          .subscribe((data) => {
